    ...
    if (this.laDate == "19") {
      this.lesEnigmes = [
        ...
        //Enigme 1
        {
          ...
          day: 1, numStand: 100, reponse: ["début", "debut","Début", "Debut", "le début", "le debut", "DEBUT", "LE DEBUT", "Le Debut", "Le Début", "le Début", "le Debut", "Le début", "LE DÉBUT", "le DÉBUT", "Le DÉBUT", "le DEBUT", "Le DEBUT", "yousk2"],
