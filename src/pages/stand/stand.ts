...
this.sqlPrd.select('SELECT * FROM `STAND` WHERE num>='+this.selectedItem.numMin+" AND num<"+this.selectedItem.numMax,null,this.stands);
...
event(stand){
  this.navCtrl.push(StandListExposantPage,{numStand:stand.num});
}
  getItems(ev: any) {
